...
export const referentielsApi = {
  getTypesBateaux: () =>
    api.get<TypeBateauAPI[]>("/api/referentiels/types-bateaux", false),
  getTypesDocuments: () =>
    api.get<TypeDocumentAPI[]>("/api/referentiels/types-documents", false),
  getRoles: () =>
    api.get<string[]>("/api/referentiels/roles", false),
  getStatutsReservations: () =>
    api.get<StatutReservationAPI[]>("/api/referentiels/statuts-reservations", false),
  getModesPaiements: () =>
    api.get<ModePaiementAPI[]>("/api/referentiels/modes-paiements", false),
  getStatutsPaiements: () =>
    api.get<StatutPaiementAPI[]>("/api/referentiels/statuts-paiements", false),
  getAssurances: () =>
    api.get<AssuranceAPI[]>("/api/referentiels/assurances", false),
};

export const portsApi = {
  getAll: () =>
    api.get<PortAPI[]>("/api/ports", false),
  getOne: (id: number | string) =>
    api.get<PortAPI>(`/api/ports/${id}`, false),
